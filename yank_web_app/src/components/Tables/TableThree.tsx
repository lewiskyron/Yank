...
const TableThree = () => {
	return (
		<div className="border-stroke shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5 rounded-[10px] border bg-white p-4">
			<div className="max-w-full overflow-x-auto">
				<table className="w-full table-auto">
					<thead>
						<tr className="dark:bg-dark-2 bg-[#F7F9FC] text-left">
							<th className="text-dark xl:pl-7.5 min-w-[220px] px-4 py-4 font-medium dark:text-white">
								Package
							</th>
							<th className="text-dark min-w-[150px] px-4 py-4 font-medium dark:text-white">
								Invoice date
							</th>
							<th className="text-dark min-w-[120px] px-4 py-4 font-medium dark:text-white">
								Status
							</th>
							<th className="text-dark xl:pr-7.5 px-4 py-4 text-right font-medium dark:text-white">
								Actions
							</th>
						</tr>
					</thead>
					<tbody>
						{packageData.map((packageItem, index) => (
							<tr key={index}>
								<td
									className={`dark:border-dark-3 xl:pl-7.5 border-[#eee] px-4 py-4 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
								>
									<h5 className="text-dark dark:text-white">
										{packageItem.name}
									</h5>
									<p className="text-body-sm mt-[3px] font-medium">
										${packageItem.price}
									</p>
								</td>
								<td
									className={`dark:border-dark-3 border-[#eee] px-4 py-4 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
								>
								...
								>
									<p
										className={`text-body-sm inline-flex rounded-full px-3.5 py-1 font-medium ${
								...
								<td
									className={`dark:border-dark-3 xl:pr-7.5 border-[#eee] px-4 py-4 ${index === packageData.length - 1 ? "border-b-0" : "border-b"}`}
								>
